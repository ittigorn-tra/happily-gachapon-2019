...
function draw_debug_section(game_area, conf)
  if conf.show_debug_messages then
    ...
    love.graphics.print('Music vol: ' ..sounds.bg_music:getVolume(), calc_debug_pos(20, 110))
    love.graphics.print('State 20 timer: ' ..state_20_timer, calc_debug_pos(20, 140))
    love.graphics.print('State 20 click count: ' ..state_20_click_count, calc_debug_pos(20, 170))
